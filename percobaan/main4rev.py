...
# Debug: Check number of audio files loaded
...
# Debug: Check transcripts after filtering
print(f"Transcripts after filtering:")
print(transcripts.head())  # Print first few rows to verify data
...
# Debug: Check number of features and labels collected
